import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QTextEdit, QAction, QMessageBox, QFileDialog, QVBoxLayout, QLabel, QLineEdit, QPushButton, QSlider
...
class TextEditor(QMainWindow):
    ...
    def create_menu(self):
        ...
        new_window_action = QAction(QIcon(), "Nouvelle fenêtre", self)
    ...
    def update_status_bar(self):
        ...
        self.status_label.setText(f'Ligne {line}, Colonne {col} | Position : {pos}')
